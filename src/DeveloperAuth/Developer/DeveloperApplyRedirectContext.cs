...
namespace DeveloperAuth.Developer
{
    ...
    /// </summary>
    public class DeveloperApplyRedirectContext : BaseContext<DeveloperAuthenticationOptions>
    {
        /// <summary>
        ...
        public DeveloperApplyRedirectContext(IOwinContext context, DeveloperAuthenticationOptions options,
