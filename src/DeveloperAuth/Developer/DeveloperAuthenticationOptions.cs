...
namespace DeveloperAuth.Developer
{
    ...
    public class DeveloperAuthenticationOptions : AuthenticationOptions
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="IDeveloperAuthenticationProvider"/> used to handle authentication events.
        /// </summary>
        public IDeveloperAuthenticationProvider Provider { get; set; }
    }
}