...
{
    public class CassandraUserHandleComparer : IEqualityComparer<CassandraUserHandle>
    {
       public static CassandraUserHandleComparer ShallowComparer
        {
            get { return new CassandraUserHandleComparer(); }
        }
       public static CassandraUserHandleComparer DeepComparer
       {
           get { return new CassandraUserHandleComparer(true); }
       }
        private bool _deep;

        public CassandraUserHandleComparer(bool deep = false)
        {
            _deep = deep;
        }

        public bool Equals(CassandraUserHandle x, CassandraUserHandle y)
        {
            if (_deep)
            {
        ...
        public int GetHashCode(CassandraUserHandle obj)
        {
        ...
        public bool ShallowEquals(CassandraUserHandle x, CassandraUserHandle y)
        {
        ...
        public bool DeepEquals(CassandraUserHandle x, CassandraUserHandle y)
        {
        ...
        public int GetShallowHashCode(CassandraUserHandle obj)
        {
       ...
       public int GetDeepHashCode(CassandraUserHandle obj)
        {
            if (ReferenceEquals(obj, null))
                return 0;
