...
namespace P5.AspNet.Identity.Biggy
{
        ...
        IUserLoginStore<User, int>
    {
        ...
        private readonly JsonStore<User> UserDb = null;
        private readonly JsonStore<Role> RoleDb = null;

        public UserStore(string folderStorage)
        {
            this.FolderStorage = folderStorage;
            this.UserDb = new JsonStore<User>(this.FolderStorage, "Indentity", "Users");
            this.RoleDb = new JsonStore<Role>(this.FolderStorage, "Indentity", "Roles");
        }
